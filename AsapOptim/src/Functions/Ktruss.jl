...
function k_truss_notangent(E::Float64, A::Float64, L::Float64)
    E * A / L * [1 -1; -1 1]
end
...
function getlocalks_notangent(E::Vector{Float64}, A::Vector{Float64}, L::Vector{Float64})
    k_truss_notangent.(E, A, L)
end